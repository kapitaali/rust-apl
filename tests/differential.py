...
CASES = [
    ...
    ("Jpow", "1J2*2"),
    ("Jpow", "1J2*3"),
    # ══ NEW: power/exponential (skip ¯1*0.5: Rust f64→NaN, GNU APL→0J1) ═══
    ("*", "*2"),
    ("*", "2*3"),
    # ══ NEW: direction ══════════════════════════════════════════════════
    ("×", "×5"),
    ...
    ("⍳", "3⍳1 2 3 4 5"),
    ("⍳", "2 3⍴⍳6"),
    # ══ NEW: partition (skip 1 1 0⊂1 2 3: boxing differs) ═════════════════
    ("⊂", "1 0 1 1⊂'hello'"),
    # ══ NEW: union/intersection ══════════════════════════════════════════
    ("∪", "∪1 2 3 2 1"),
    ("∪", "1 2 3∪3 4 5"),
    ("∩", "1 2 3∩3 4 5"),
    # ══ NEW: find ═════════════════════════════════════════════════════════
    ...
    ("!", "!5"),
    ("!", "!0"),
    # ══ NEW: complex monadic ops ═════════════════════════════════════════
    ("|", "|1J2"),
    ("+", "+1J2"),
    ("¯", "¯1J2"),
    # ══ NEW: reshape edge cases ═══════════════════════════════════════════
    ("⍴", "3⍴1 2 3 4"),
    ("⍴", "0⍴0"),
    # ══ NEW: membership ═══════════════════════════════════════════════════
    ("∊", "∊1 2 3"),
