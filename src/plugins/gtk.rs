    ...
    GTK_HANDLE.with(|handle| {
        ...
        thread::spawn(move || {
            ...
            let buttons: Vec<(&str, i32, i32, i32)> = vec![
                ...
                ("C", 0, 0, 1), ("CE", 1, 0, 1), ("⌫", 2, 0, 1), ("⋄", 3, 0, 1), ("⍝", 4, 0, 1),
                // Row 1: Numbers + basic ops
                ("7", 0, 1, 1), ("8", 1, 1, 1), ("9", 2, 1, 1), ("÷", 3, 1, 1), ("+", 4, 1, 1),
                // Row 2: Numbers + basic ops
                ("4", 0, 2, 1), ("5", 1, 2, 1), ("6", 2, 2, 1), ("×", 3, 2, 1), ("−", 4, 2, 1),
                // Row 3: Numbers + basic ops
                ("1", 0, 3, 1), ("2", 1, 3, 1), ("3", 2, 3, 1), ("⋆", 3, 3, 1), ("|", 4, 3, 1),
                // Row 4: Zero + comparison
                ("0", 0, 4, 1), (".", 1, 4, 1), ("=", 2, 4, 1), ("<", 3, 4, 1), ("≤", 4, 4, 1),
                // Row 5: Comparison + logic
                ...
                // Row 12: Actions
                ("(", 0, 12, 1), (")", 1, 12, 1), ("Compute", 2, 12, 2), ("Plot", 0, 13, 2), ("History", 2, 13, 2),
            ];
