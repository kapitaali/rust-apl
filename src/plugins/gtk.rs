    ...
    GTK_HANDLE.with(|handle| {
        ...
        thread::spawn(move || {
            ...
            let buttons: Vec<(&str, i32, i32, i32)> = vec![
                ...
                ("C", 0, 0, 1), ("CE", 1, 0, 1), ("⌫", 2, 0, 1), ("⋄", 3, 0, 1), ("⍝", 4, 0, 1), ("∇", 5, 0, 1),
                // Row 1: Numbers + basic ops
                ("7", 0, 1, 1), ("8", 1, 1, 1), ("9", 2, 1, 1), ("÷", 3, 1, 1), ("+", 4, 1, 1), ("−", 5, 1, 1),
                // Row 2: Numbers + basic ops
                ("4", 0, 2, 1), ("5", 1, 2, 1), ("6", 2, 2, 1), ("×", 3, 2, 1), ("⋆", 4, 2, 1), ("|", 5, 2, 1),
                // Row 3: Numbers + basic ops
                ("1", 0, 3, 1), ("2", 1, 3, 1), ("3", 2, 3, 1), ("=", 3, 3, 1), ("<", 4, 3, 1), ("≤", 5, 3, 1),
                // Row 4: Zero + comparison
                ("0", 0, 4, 1), (".", 1, 4, 1), (">", 2, 4, 1), ("≥", 3, 4, 1), ("≠", 4, 4, 1), ("∧", 5, 4, 1),
                // Row 5: Logic + array ops
                ("∨", 0, 5, 1), ("⍳", 1, 5, 1), ("⍴", 2, 5, 1), ("↑", 3, 5, 1), ("↓", 4, 5, 1), ("⌽", 5, 5, 1),
                // Row 6: Array ops
                ("⍉", 0, 6, 1), ("⍋", 1, 6, 1), ("⍒", 2, 6, 1), ("∈", 3, 6, 1), ("⊂", 4, 6, 1), ("⊃", 5, 6, 1),
                // Row 7: Array ops
                ("≡", 0, 7, 1), ("≢", 1, 7, 1), ("⊤", 2, 7, 1), ("⊥", 3, 7, 1), ("→", 4, 7, 1), ("⌹", 5, 7, 1),
                // Row 8: Misc
                ("⍕", 0, 8, 1), ("⍎", 1, 8, 1), ("⍸", 2, 8, 1), ("⍬", 3, 8, 1), ("⍺", 4, 8, 1), ("⍵", 5, 8, 1),
                // Row 9: Operators
                ("/", 0, 9, 1), ("\\", 1, 9, 1), ("¨", 2, 9, 1), ("⍨", 3, 9, 1), ("∘.", 4, 9, 1), ("⎕", 5, 9, 1),
                // Row 10: Actions
                ("(", 0, 10, 1), (")", 1, 10, 1), ("Compute", 2, 10, 2), ("Plot", 4, 10, 2),
                ("History", 0, 11, 2), ("Clear", 2, 11, 2), ("Quit", 4, 11, 2),
            ];
